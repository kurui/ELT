 ...
 */
@Entity
public class ImportStaffBatch implements Serializable {
	/**
	 * 
	 */
	...
	private ImportStaffHavingTitle havingTitle;
	...
	public ImportStaffHavingTitle getHavingTitle() {
		return havingTitle;
	}

	public void setHavingTitle(ImportStaffHavingTitle havingTitle) {
