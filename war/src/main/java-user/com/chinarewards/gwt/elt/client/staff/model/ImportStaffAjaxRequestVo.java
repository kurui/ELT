 ...
 */
public class ImportStaffAjaxRequestVo implements IsSerializable {
	 ...
	 * 导入员工列表
	 */
	private List<ImportStaffRawVo> staffRawList = new ArrayList<ImportStaffRawVo>();
	 ...
	 */
	public List<ImportStaffRawVo> getStaffRawList() {
		return staffRawList;
	}
	 ...
	 */
	public void setStaffRawList(List<ImportStaffRawVo> staffRawList) {
	...
	public String toString() {
		return "ImportStaffAjaxRequestVo [action=" + action + ", id=" + id
