 ...
 *
 */
public class SearchLeaderChooseRequest implements Action<SearchLeaderChooseResponse> {
	...
	public SearchLeaderChooseRequest() {
	}

	public SearchLeaderChooseRequest(LeaderSearchCriteria criteria,
