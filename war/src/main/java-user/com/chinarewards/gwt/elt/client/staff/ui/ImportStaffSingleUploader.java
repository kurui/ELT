...
public class ImportStaffSingleUploader extends Uploader {
   ...
   * 
   */
  public ImportStaffSingleUploader() {
   ...
   *        file input to use
   */
  public ImportStaffSingleUploader(FileInputType type) {
    this(type, null);
  }
   ...
   */
  public ImportStaffSingleUploader(FileInputType type, IUploadStatus status) {
   ...
   */
  public ImportStaffSingleUploader(FileInputType type, IUploadStatus status, Button button) {
   ...
   */
  public ImportStaffSingleUploader(FileInputType type, IUploadStatus status, Button button, FormPanel form) {
    super(type, form);

   // final Uploader thisInstance = this;

    if (status == null) {
      status = new ImportStaffModalUploadStatus();
    }
...
//    });
   ...
   *        Customized status widget to use
   */
  public ImportStaffSingleUploader(IUploadStatus status) {
   ...
   *        Customized button which submits the form
   */
  public ImportStaffSingleUploader(IUploadStatus status, Button button) {
