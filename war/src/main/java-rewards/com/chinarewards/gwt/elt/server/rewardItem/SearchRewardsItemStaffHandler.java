 ...
 * @author yanrui
 */
public class SearchRewardsItemStaffHandler extends	BaseActionHandler<SearchStaffRewardsItemRequest, SearchStaffRewardsItemResponse> {
	...
	@Inject
	public SearchRewardsItemStaffHandler(RewardItemService rewardItemService) {
