...
public class AwardRewardDetermineWidget extends Composite implements AwardRewardDetermineDisplay {
	...
	interface AwardRewardWidgetUiBinder extends UiBinder<Widget, AwardRewardDetermineWidget> {
	}
