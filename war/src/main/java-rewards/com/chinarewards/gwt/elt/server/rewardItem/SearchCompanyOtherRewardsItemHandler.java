 ...
 * @author yanrui
 */
public class SearchCompanyOtherRewardsItemHandler extends	BaseActionHandler<SearchCompanyOtherRewardsItemRequest, SearchCompanyOtherRewardsItemResponse> {
	...
	@Inject
	public SearchCompanyOtherRewardsItemHandler(RewardItemService rewardItemService) {
