		...
		ext.add(new Extension() {
			...
			public Object getInstance() {
				return new MenuItem() {
					...
					@Override
					public int getOrder() {
						return MenuConstants.MENU_ORDER_REWARDSITEM_SEARCH;
					}

					@Override
					public String getMenuId() {
						return RewardsItemConstants.MENU_REWARDSITEM_SEARCH;
					}
					...
					public void execute() {
						Platform.getInstance()
								.getEditorRegistry()
								.openEditor(
										RewardsItemConstants.EDITOR_REWARDSITEM_SEARCH,
										"EDITOR_REWARDSITEM_SEARCH_DO_ID", null);
					}
