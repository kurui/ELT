 ...
 */
public class IntegralManagementRequest implements Action<IntegralManagementResponse> {
	...
	public IntegralManagementRequest(GiftCriteria gift,String corporationId,UserRoleVo[] userRoles,String userId) {
		this.gift = gift;
