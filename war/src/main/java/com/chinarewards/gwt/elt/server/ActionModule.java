...
import com.chinarewards.gwt.elt.server.gift.ExportGiftHandler;
...
public class ActionModule extends ActionHandlerModule {
	...
	protected void configureHandlers() {
		...
		bindHandler(JudgeStaffAccountRequest.class,JudgeStaffAccountHandler.class);
      ...
      //删除奖项
		...
		bindHandler(ExportGiftRequest.class, ExportGiftHandler.class);	   
