...
public abstract class MenuConstants {
	...
	// 企业邮箱设置
	public static final int MENU_ORDER_MAILSET_EDIT = order++;
	// 提前颁奖通知时间设置
	...
	// 奖项库列表查询
	public static final int MENU_ORDER_REWARDSITEMStore_List = order++;
	// 新建奖项
	...
	// 我的奖项列表
	public static final int MENU_ORDER_REWARDSLIST_STAFF_SEARCH = order++;
