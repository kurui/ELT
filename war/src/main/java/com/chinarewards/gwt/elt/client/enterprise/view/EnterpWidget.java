...
public class EnterpWidget extends Composite  implements EnterpriseDisplay {
	...
	private static EnterpWidgetUiBinder uiBinder = GWT
			.create(EnterpWidgetUiBinder.class);
	@UiField TextBox enterpriseName;
	@UiField TextBox corporation;
	@UiField TextBox address;
	@UiField TextBox linkman;
	@UiField TextBox tell;
	@UiField TextBox cellphone;
