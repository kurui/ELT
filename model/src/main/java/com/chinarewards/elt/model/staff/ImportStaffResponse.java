 ...
 */
public class ImportStaffResponse extends ImportStaffRequest {

	public ImportStaffResponse() {
		super();
	}

	public ImportStaffResponse(ImportStaffRequest request) {
	 ...
	 * 部门分析结果
	 */
	private List<String> importStaffDepartment;
	 ...
	 * @return
	 */
	public List<String> getImportStaffDepartment() {
		return importStaffDepartment;
	}

	public void setImportStaffDepartment(List<String> importStaffDepartment) {
		this.importStaffDepartment = importStaffDepartment;
	}
	...
	public String toString() {
		return "ImportStaffResponse [importBatchNo=" + importBatchNo
				...
				+ finalFailedNum + ", importStaffRawCode=" + importStaffRawCode
				+ ", importStaffDepartment=" + importStaffDepartment
